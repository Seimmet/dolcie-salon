...
async function main() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: `A ${depositAmount} non-refundable booking deposit is required at the time of booking and is not applied toward your final service total. Please be prepared to make payment when booking.\nOnce your deposit is secured, you are allowed one reschedule within the approved time frame.`,
      order: 2
    },
    {
